def is_bearish_candle(open_price, high_price, low_price, close_price):
    ...
    return is_full_red_body and has_small_upper_wick and has_small_lower_wick and close_price < 90
...
def is_bearish_hammer_candle(open_price, high_price, low_price, close_price):
    ...
    has_small_upper_wick = upper_wick <= abs(body_size) * 0.3  # Adjust the threshold as per your preference
    
    return is_full_red_body and has_long_lower_wick and has_small_upper_wick and close_price < 90
