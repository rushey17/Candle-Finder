...
def is_bullish_candle(open_price, high_price, low_price, close_price):
   ...
   return is_full_green_body and has_small_upper_wick and has_small_lower_wick and close_price > 50
...
def is_bullish_hammer_candle(open_price, high_price, low_price, close_price):
   ...
   has_small_upper_wick = upper_wick <= body_size * 0.01  # Adjust the threshold as per your preference
   
   return is_full_green_body and has_long_lower_wick and has_small_upper_wick and close_price > 50
